  ...
  return (
    <div className="grid relative w-full grid-flow-row gap-10 text-center md:gap-4 md:text-left lg:mb-0 grid-cols-1 lg:grid-cols-2">
      {services.map((serviceItem) => (
        ...
        >
          <div className="h-64 w-auto overflow-hidden light:rounded-3xl dark:rounded-3xl group-hover:md:scale-125 group-hover:z-20 group-hover:border bg-zinc-900 border-zinc-200/70 duration-300 relative">
            <Image
            ...
            <div className="absolute top-0 left-0 w-full h-full p-4 justify-start align-top ">
              ...
              <p className="text-sm text-zinc-200/70 justify-start align-top">
