...
export function Certifications() {
  return (
    <div className="grid relative w-full grid-flow-row gap-10 text-center md:gap-4 md:text-left lg:mb-0 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
      {certifications.map((certificationItem) => (
        ...
        >
          <div className="h-42 sm:h-32 lg:h-64 w-full overflow-hidden light:rounded-3xl dark:rounded-3xl group-hover:md:scale-125 group-hover:z-20 light:bg-zinc-200 dark:bg-zinc-900 retro:bg-fuchsia-950/70 duration-300 relative place-content-center light:border-white dark:border-zinc-200/70 group-hover:border">
