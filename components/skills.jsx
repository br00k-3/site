    ...
    <div className="w-full flex flex-col lg:flex-row items-center justify-center space-y-4 lg:space-y-2 lg:space-x-8">
      {studioskills.map((studioskillsItem) => (
        ...
        >
          ...
          />
          <div className="opacity-100 lg:opacity-0 group-hover:opacity-100 h-full pt-[5.5rem] lg:pt-[4.5rem] z-0 transition group-hover:duration-300 flex-col delay-100">
